...
State   Recv-Q   Send-Q     Local Address:Port    Peer Address:Port     Process
UNCONN  0        0          10.0.2.15%eth0:68     0.0.0.0:*             users:(("systemd-network",pid=604,fd=20))
UNCONN  0        0          127.0.0.53%lo:53      0.0.0.0:*             users:(("systemd-resolve",pid=606,fd=12))

```

68 и 53 порт UDP использует systemd
